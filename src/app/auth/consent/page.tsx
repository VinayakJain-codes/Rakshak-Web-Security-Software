...
export default function GuardConsentPage() {
  ...
  const texts = {
    EN: {
        ...
        locationDesc: 'Your GPS location is strictly monitored ONLY during your scheduled shift hours. Background tracking automatically turns off when you are off-duty.',
    ...
    HI: {
        ...
        locationDesc: 'आपके GPS स्थान की सख्ती से निगरानी केवल आपके निर्धारित शिफ्ट घंटों के दौरान की जाती है। जब आप ड्यूटी पर नहीं होते हैं तो बैकग्राउंड ट्रैकिंग स्वचालित रूप से बंद हो जाती है।',
